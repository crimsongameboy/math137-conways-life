...
getStatus neighbornumber currentstatus =
    let
        newStatus : CellStatus
        newStatus =
            if neighbornumber < 2 && currentstatus == Alive
            then Dead
            else if neighbornumber > 3 && currentstatus == Alive
                then Dead
                else if neighbornumber == 3 && currentstatus == Dead
                    then Alive
                    else currentstatus
    in
    newStatus
